...
class ArithmeticExpClass extends ExpClass implements ArithmeticExp {
	...
	public ExpVal value(Map<String,ExpVal> env) {
		...
		Map<String,ExpVal> leftEnv = new HashMap<String,ExpVal>(env);
		Map<String,ExpVal> rightEnv = new HashMap<String,ExpVal>(env);
		
		leftResult = this.leftOperand().value(leftEnv);
		rightResult = this.rightOperand().value(rightEnv);
