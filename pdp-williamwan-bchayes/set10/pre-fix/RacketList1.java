...
//   new RacketList1<E>()
//   new RacketList1<E>(f)
//   new RacketList1<E>(f, rktList)
// Interpretation:
//   f is the first element of the RacketList.
//   rktList is a RacketList1<E> that represent the rest of the 
//     RacketList with the first element omitted. 
//   if both f and rktList is omitted, creates an empty RacketList
